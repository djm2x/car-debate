...
var routes = [
    ...
    { path: 'admin', loadChildren: './admin/admin.module#AdminModule', data: { preload: true, delay: false } },
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: getOriginUrl, getRequest, AppModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOriginUrl", function() { return getOriginUrl; });
...
/* harmony import */ var _nguniversal_aspnetcore_engine_tokens__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nguniversal/aspnetcore-engine/tokens */ "./node_modules/@nguniversal/aspnetcore-engine/fesm5/tokens.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _utils_loader_loader_interceptor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/loader/loader-interceptor */ "./src/app/utils/loader/loader-interceptor.ts");
            ...
            providers: [
                {
                    ...
                    provide: _nguniversal_aspnetcore_engine_tokens__WEBPACK_IMPORTED_MODULE_9__["ORIGIN_URL"],
                    useFactory: (getOriginUrl)
                }, {
                    // The server provides these in main.server
                    provide: _nguniversal_aspnetcore_engine_tokens__WEBPACK_IMPORTED_MODULE_9__["REQUEST"],
                    useFactory: (getRequest)
                },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"],
                    useClass: _utils_loader_loader_interceptor__WEBPACK_IMPORTED_MODULE_11__["LoaderInterceptor"],
                    multi: true
                },
            ],
...
/***/ "./src/app/shared/mytoastr.service.ts":
/*!********************************************!*\
  !*** ./src/app/shared/mytoastr.service.ts ***!
  \********************************************/
/*! exports provided: MyToastrService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyToastrService", function() { return MyToastrService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MyToastrService = /** @class */ (function () {
    function MyToastrService(toastr) {
        ...
        this.toastError = function (msg, description) { return _this.toastr.error(msg, description, _this.myConfig); };
    }
    MyToastrService.prototype.toastNotif = function (o) {
        switch (o.color) {
            case 1:
    ...
    MyToastrService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _snack_bar_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./snack-bar.service */ "./src/app/utils/loader/snack-bar.service.ts");
/* harmony import */ var _shared_mytoastr_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/mytoastr.service */ "./src/app/shared/mytoastr.service.ts");
...
var LoaderInterceptor = /** @class */ (function () {
    function LoaderInterceptor(loaderService, router, snackBar, toast) {
    ...
    LoaderInterceptor.prototype.intercept = function (req, next) {
        ...
        //
        var o = rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].create(function (observer) {
            var s = next.handle(req).subscribe(function (event) {
                ...
                if (err instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]) {
                    ...
                    _this.toast.toastError(err.error.message, err.error.Description);
    ...
    LoaderInterceptor.prototype.collectFailedRequest = function (request) {
        this.cachedRequests.push(request);
    };
    LoaderInterceptor.prototype.retryFailedRequests = function () {
    ...
    LoaderInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_loader_service__WEBPACK_IMPORTED_MODULE_4__["LoaderService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
            _snack_bar_service__WEBPACK_IMPORTED_MODULE_6__["SnackBarService"], _shared_mytoastr_service__WEBPACK_IMPORTED_MODULE_7__["MyToastrService"]])
    ], LoaderInterceptor);
...
/***/ "./src/app/utils/loader/snack-bar.service.ts":
/*!***************************************************!*\
  !*** ./src/app/utils/loader/snack-bar.service.ts ***!
  \***************************************************/
...
var SnackBarService = /** @class */ (function () {
    ...
    SnackBarService.prototype.notifyOk = function (message) {
        var config = {
    ...
    SnackBarService.prototype.notifyAlert = function (message) {
        var config = {
            panelClass: ['green-snackbar'],
            duration: 7500
        };
...
module.exports = __webpack_require__(/*! D:\dev\aspTestApp\mvc\src\main.ts */"./src/main.ts");
