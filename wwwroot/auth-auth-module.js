...
var routes = [
    { path: '', redirectTo: '', pathMatch: 'full' },
    {
        ...
        children: [
            ...
            { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_4__["LoginComponent"], data: { state: 'login' } },
        ]
    }
];
